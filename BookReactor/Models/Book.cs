...
public class Offers
{
    ...
    public ListPriceInMicros listPrice { get; set; }
    public RetailPriceInMicros retailPrice { get; set; }
    public bool giftable { get; set; }
}
public class RetailPriceInMicros
{
    public double amountInMicros { get; set; }
    public string currencyCode { get; set; }
}
public class ListPriceInMicros
{
    public double amountInMicros { get; set; }
    public string currencyCode { get; set; }
}
